...
const initialNodes = [
  ...
  { id: '8', type: 'rectangle2', position: { x: -390, y:-25}, draggable: true},
...
const initialEdges = [
  { id: 'e1', source: '2', target: '1',sourceHandle: 'e4s',targetHandle: 'e2t', type: 'straight',style: {stroke: '#484848',strokeWidth: 8}},
  { id: 'e2', source: '3', target: '2',sourceHandle: 'e6s',targetHandle: 'e4t', type: 'straight',style: {stroke: '#484848',strokeWidth: 8}},
  { id: 'e3', source: '2', target: '1',sourceHandle: 'e3s',targetHandle: 'e1t', type: 'straight',style: {stroke: '#484848',strokeWidth: 8}},
  { id: 'e4', source: '3', target: '2',sourceHandle: 'e5s',targetHandle: 'e3t', type: 'straight',style: {stroke: '#484848',strokeWidth: 8}},
  { id: 'e5', source: '5', target: '4',sourceHandle: 'e9s',targetHandle: 'e7t', type: 'straight',style: {stroke: '#484848',strokeWidth: 8}},
  { id: 'e6', source: '5', target: '4',sourceHandle: 'e10s',targetHandle: 'e8t', type: 'straight',style: {stroke: '#484848',strokeWidth: 8}},
  { id: 'e7', source: '6', target: '5',sourceHandle: 'e11s',targetHandle: 'e9t', type: 'straight',style: {stroke: '#484848',strokeWidth: 8}},
  { id: 'e8', source: '6', target: '5',sourceHandle: 'e12s',targetHandle: 'e10t', type: 'straight',style: {stroke: '#484848',strokeWidth: 8}},
  { id: 'e9', source: '3', target: '6',sourceHandle: 'e6s',targetHandle: 'e11t', type: 'smoothstep',style: {stroke: '#484848',strokeWidth: 8}},
  { id: 'e10', source: '19', target: '3',sourceHandle: 'e13s',targetHandle: 'e5t', type: 'straight',style: {stroke: '#484848',strokeWidth: 8}},
  { id: 'e11', source: '20', target: '6',sourceHandle: 'e14s',targetHandle: 'e11t', type: 'smoothstep',style: {stroke: '#484848',strokeWidth: 8}},
  { id: 'e12', source: '21', target: '3',sourceHandle: 'e15s',targetHandle: 'e5t', type: 'smoothstep',style: {stroke: '#484848',strokeWidth: 8}},
  // { id: 'e13', source: '6', target: '3',sourceHandle: 'e12s',targetHandle: 'e5t', type: 'smoothstep',style: {stroke: '#484848',strokeWidth: 8}},
  { id: 'e14', source: '6', target: '22',sourceHandle: 'e12s',targetHandle: 'e16t', type: 'smoothstep',style: {stroke: '#484848',strokeWidth: 8}},
  { id: 'e15', source: '23', target: '24',sourceHandle: 'e17s',targetHandle: 'e18t', type: 'smoothstep',style: {stroke: '#484848',strokeWidth: 8}},
